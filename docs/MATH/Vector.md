...
そのために、グラム・シュミットの正規直交化法を使用します。この方法では、与えられたベクトルの組を直交する正規なベクトルの組に変換します。以下は、グラム・シュミットの正規直交化法の手順です。

与えられた3次元ベクトルの組を $\mathbf{v}_1, \mathbf{v}_2, \mathbf{v}_3$ とします。
